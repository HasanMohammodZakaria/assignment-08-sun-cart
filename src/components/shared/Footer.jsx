...
const Footer = () => {
  return (
    <footer className="bg-[#005691] text-white pt-14 pb-8 px-4 md:px-10 lg:px-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        <div className="text-center lg:text-left flex flex-col items-center lg:items-start">
          <Image src={LogoFt} alt="Logo" width={280} height={60} />
      ...
      <div className="max-w-7xl mx-auto mt-10 border-t border-white/20 pt-5 text-center text-xs text-white/70">
        © {new Date().getFullYear()} SUN CART. All Rights Reserved.
      </div>
    </footer>
  );
};
